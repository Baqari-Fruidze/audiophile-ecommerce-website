    ...
    <div className="parent flex flex-col gap-[48px] items-center bg-[#101010] px-[24px] pb-[38px] mt-[120px]">
      ...
      <div className=" audiophileCon flex flex-col gap-[48px] ">
        ...
        <div className="items flex flex-col gap-[16px] items-center">
          <Link className={`common`}>Home</Link>
          <Link className={`common`}> HEADPHONES</Link>
          <Link className={`common`}>SPEAKERS</Link>
          <Link className={`common`}>EARPHONES</Link>
        </div>
      </div>
      <div className="textAndIconCon  flex flex-col gap-[48px]">
        <p className="text-[#fff] text-[15px] font-bold leading-[25px] opacity-50 text-center">
